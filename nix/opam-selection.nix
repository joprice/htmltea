    ...
    repos = 
    {
      ...
      rec {
        fetch = 
        {
          ...
          rev = "7b3f187fa1d066ca11c5d73383ec5172f5bf857c";
          sha256 = "0pdcgbrwvgk7kal81kvdapcx54861353ds87dakj99m1c97rf6kn";
        };
...
in
{
  ...
  selection = 
  {
    ...
    b0 = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:0vlwbgw7lvi2lnk6jn5g10891wrk9pifv92n4ppqvm5fc09d99f1";
        package = "packages/b0/b0.0.0.1";
      };
      pname = "b0";
      src = pkgs.fetchurl 
      {
        sha256 = "015y8vsqm16smqh8p6yrqzfsbikyxjypfp75gvlbiwrr3xbzr8nv";
        url = "https://erratique.ch/software/b0/releases/b0-0.0.1.tbz";
      };
      version = "0.0.1";
    };
    base = 
    ...
    curly = 
    {
      ...
      opamInputs = 
      {
        ...
        base-unix = selection.base-unix;
        cohttp-lwt-unix = selection.cohttp-lwt-unix or null;
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:1y5r9f4339v44iyymfx247jp8famk6q57aviy1nld68fizfcfir9";
        package = "packages/curly/curly.0.1.0";
      };
      pname = "curly";
      src = pkgs.fetchurl 
      {
    ...
    htmltea = 
    {
      opamInputs = 
      {
        curly = selection.curly;
        lambdasoup = selection.lambdasoup;
        ocamlformat = selection.ocamlformat;
        ocp-browser = selection.ocp-browser;
        odig = selection.odig;
        ppx_deriving = selection.ppx_deriving;
        utop = selection.utop;
      };
      opamSrc = "htmltea.opam";
      pname = "htmltea";
      src = self.directSrc "htmltea";
      version = "development";
    };
    jbuilder = 
    {
    ...
    ocamlformat = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:1z4y22261lysfb9dvmpdmcyfi2pvgr3f37dbki3sd638xka9svjb";
    ...
    ocp-browser = 
    {
      opamInputs = 
      {
        ...
        ocaml = selection.ocaml;
        ocp-index = selection.ocp-index;
        zed = selection.zed;
      };
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:1sgglhc1c3m343w9g7ngh1kfrbnnz14s2g1lim4m2jz1jm06wfp1";
        package = "packages/ocp-browser/ocp-browser.1.2.1";
      };
      pname = "ocp-browser";
      src = pkgs.fetchurl 
      {
        sha256 = "169msb3k1ip5lp79lr62nsk715rwrn53x9jcrnxz4js7c0fv0cyr";
        url = "https://github.com/OCamlPro/ocp-index/archive/1.2.1.tar.gz";
      };
      version = "1.2.1";
    };
    ocp-indent = 
    ...
    ocp-index = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:04wa14vfrfw9x502bcsj76aih8jnda5mfhirj4b3k5y8f7xcs4sa";
        package = "packages/ocp-index/ocp-index.1.2.1";
      };
      pname = "ocp-index";
      src = pkgs.fetchurl 
      {
    ...
    odig = 
    {
      ...
      opamSrc = repoPath (repos.opam-repository.src) 
      {
        hash = "sha256:0dm0284r7x8cx6md4nws7i8rxfdvbcl5ylrislkhdz7saq1g1j27";
        package = "packages/odig/odig.0.0.5";
      };
      pname = "odig";
      src = pkgs.fetchurl 
      {
        sha256 = "1yvlci6c03p7i358dl2g6hl46n5wq2vdxfvszmwljnvq0nx6y33s";
        url = "https://erratique.ch/software/odig/releases/odig-0.0.5.tbz";
      };
      version = "0.0.5";
    };
    odoc = 
